...
ggplot(df_Votes_Ages1, aes(x=pop1835, y=IN_votes_percent)) +
...
ggplot(df_Votes_Ages1, aes(x=pop60p, y=IN_votes_percent)) +
  geom_point(alpha=0.5, color="#c0392b") +
  geom_hline(yintercept=1, size=0.4, color="black") +
  geom_smooth(method= lm, alpha=0.25, color="#c0392b", fill="#c0392b") +
  theme_minimal() + theme(aspect.ratio=1) +
...
ggplot(df_Votes_Ages2, aes(x=pop1835, y=EST_votes_percent)) +
  geom_point(alpha=0.5, color="#c0392b") +
  geom_hline(yintercept=1, size=0.4, color="black") +
  geom_smooth(method= lm, alpha=0.25, color="#c0392b", fill="#c0392b") +
  theme_minimal() + theme(aspect.ratio=1) +
  labs(x="18-35 %", y="EST %", title="")

ggplot(df_Votes_Ages2, aes(x=pop60p, y=EST_votes_percent)) +
  geom_point(alpha=0.5, color="#c0392b") +
  geom_hline(yintercept=1, size=0.4, color="black") +
  geom_smooth(method= lm, alpha=0.25, color="#c0392b", fill="#c0392b") +
  theme_minimal() + theme(aspect.ratio=1) +
  labs(x="60+  %", y="EST %", title="")
```
